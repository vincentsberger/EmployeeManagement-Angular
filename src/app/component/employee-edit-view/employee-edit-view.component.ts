...
export class EmployeeEditViewComponent {
  ...
  constructor(
    ...
    this.currentEmployeeQualifications$ = this.qualificationService.getQualificationsByEmployeeId(this.employeeId);
  ...
  public updateEmployee(): void {
    if(this.employeeForm.valid) {
      let formData: PostEmployeeDTO = this.employeeForm.value;
